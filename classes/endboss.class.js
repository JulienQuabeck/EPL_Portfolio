class Endboss extends MovableObject {
    ...
    */
    ...
    /**
     * This function determines the direction of the Endboss
     */
    determineDirection() {
 ...
 */
    ...
    /**
     * This function checks, if it is possible for the Endboss to move to the left
     * @param {int} direction -1 for left movement and 1 for a right movement
     * @returns true / false
     */
    ...
    /**
     * This function checks, if it is possible for the Endboss to move to the right
     * @param {int} direction -1 for left movement and 1 for a right movement
     * @returns true / false
     */
